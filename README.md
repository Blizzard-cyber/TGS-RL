...
| 当前单卡毕业实验 | [E1–E8 设计](docs/design/gate-e1-e8.md) | E6 已正式通过；E5-STATIC 已冻结 32% 门槛、待独立确认 |
...
`60/900/400 ms`，并在后续提交的独立确认运行中正式通过；E5-STATIC 已按同一方法冻结
`32%` 干扰率门槛，等待后续干净提交独立确认。

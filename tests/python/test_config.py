...
class ConfigLoaderTests(unittest.TestCase):
    def test_load_bundle_reads_real_config_graph(self) -> None:
        ...
        self.assertEqual(bundle.policy.actions.max_actions_per_tick, 8)
        self.assertEqual(bundle.policy.actions.max_affected_sandboxes, 8)
        self.assertEqual(bundle.policy.actions.max_gpu_reconfigurations, 1)
        self.assertEqual(bundle.policy.actions.max_recovery_cost_nanos, 30_000_000_000)
        self.assertFalse(bundle.policy.actions.disable_l4)

...
func (s *fakeStream) Recv() (*Snapshot, error) {
	...
	s.index++
	return &Snapshot{ObservedGeneration: value.ObservedGeneration, WorkloadAdmitted: value.WorkloadAdmitted, ResourceClaimsAllocated: value.ResourceClaimsAllocated, AllocatedDeviceIDs: append([]string(nil), value.AllocatedDeviceIDs...), JobActive: value.JobActive, WorkerRegistrationRequired: value.WorkerRegistrationRequired, PodReady: value.PodReady, JobSucceeded: value.JobSucceeded, JobFailed: value.JobFailed, JobPaused: value.JobPaused, JobDeleted: value.JobDeleted, Reason: value.Reason, ObservedAt: value.ObservedAt, ControlRequestID: value.ControlRequestID, ControlIdempotencyKey: value.ControlIdempotencyKey, ControlAction: value.ControlAction, ControlBackendRevision: value.ControlBackendRevision, ControlCommitted: value.ControlCommitted, ControlRetireRun: value.ControlRetireRun}, nil
}

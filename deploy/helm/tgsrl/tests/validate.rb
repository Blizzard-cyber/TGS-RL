...
begin
  ...
  assert(scheduler_args.include?("--worker-registry-state=/var/lib/tgsrl-scheduler/worker-registry/state.json"), "worker registry must use an owned subdirectory")
  ...
  assert(gpu_args.include?("--nvidia-binding-state=/var/lib/tgsrl-scheduler/nvidia-binding/state.json"), "NVIDIA binding helper must use an owned subdirectory")
  assert(gpu_args.include?("--nvidia-runtime-state=/var/lib/tgsrl-scheduler/nvidia-runtime/state.json"), "NVIDIA runtime helper must use an owned subdirectory")
  assert(gpu_args.include?("--worker-registry-state=/var/lib/tgsrl-scheduler/nvidia-runtime/state.json"), "NVIDIA runtime helper and registry must share worker state")
